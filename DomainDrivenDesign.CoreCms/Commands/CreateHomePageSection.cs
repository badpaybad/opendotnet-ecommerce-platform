...
{
    public class CreateHomePageSection : AdminBaseCommand
    {
        public Guid Id { get; }
        ...
        public CreateHomePageSection(Guid id, string title, Guid categoryId, Guid languageId, short displayOrder, string viewName
