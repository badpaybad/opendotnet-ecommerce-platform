...
{
    public class UpdateProductForSeo : AdminBaseCommand
    {
        public Guid Id { get; }
        ...
        public UpdateProductForSeo(Guid id, string seoKeywords, string seoDescription, Guid languageId, string seoUrlFriendly
